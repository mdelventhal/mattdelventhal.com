...
The company's problem can then formally be given as $$ \min\limits_{x_{jkr},t_j} \left \\{   \sum\limits_{j=1}^J \pi_j \times \left \[ \begin{array}{l} \left ( 1 - z_j  \right ) \cdot C_1  \\\\ \\\\ \quad + z_j \cdot \left \[ \max \\{ a \\} + \max \\{ b \\} + \max \\{ c \\}  \right \] \end{array}\right \] \right \\} $$
